...
@pytest.fixture
def test_db():
    """File-based SQLite test database, unique per test to ensure isolation."""
    db_name = f"test_travel_{uuid.uuid4().hex[:8]}.db"
    ...
    from app.models import outfit_log  # noqa: F401
